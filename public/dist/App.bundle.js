...
function disableTweetButton(form) {
  var input = form.querySelector('#tweet-input');
  var button = form.querySelector('#tweet-submit');
  if (input) {
...
exports.default = disableTweetButton;
...
var _likeTweet = __webpack_require__(13);

var _likeTweet2 = _interopRequireDefault(_likeTweet);

var _toggleScreen = __webpack_require__(14);
